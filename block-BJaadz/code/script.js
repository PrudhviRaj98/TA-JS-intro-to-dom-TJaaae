...
document.querySelectorAll("hr.img").forEach((ele)=> ele.style.border = " 2px solid purple");
...
*/
let box16 = document.querySelector(".sixtee");
...
let p  = document.createElement("p");
p.innerText = "kemelkm";
let text = document.createTextNode("append")
box2.prepend(p);
...
input.placeholder = "enter your eail";
